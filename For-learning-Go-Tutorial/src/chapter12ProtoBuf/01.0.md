...
然而编译Grpc需要Protobufer编译器,那么Protobufer又是什么呢![](https://cdn.jsdelivr.net/gh/wulling1024/Picture-bed@master/img20200620200630155101.jpg)
...
在proto3中，repeated的标量域默认情况下可以使用packed.如果想要了解更多可以查看[Protocol Buffer编码原理](https://developers.google.com/protocol-buffers/docs/encoding?hl=zh-cn#packed).
...
![](https://cdn.jsdelivr.net/gh/wulling1024/Picture-bed@master/img20200620200630155219.jpg)


如果需要了解更多可以查看[Protocol Buffer编码原理](https://developers.google.com/protocol-buffers/docs/encoding?hl=zh-cn#packed).了解更多“序列化消息时各种类型如何编码”的信息。
...
![](https://cdn.jsdelivr.net/gh/wulling1024/Picture-bed@master/img20200620200630155308.jpg)
